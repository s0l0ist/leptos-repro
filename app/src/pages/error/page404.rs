...
#[component]
pub fn Page404(#[prop(optional, default = None)] message: Option<String>) -> impl IntoView {
    let error_desc = "Page not found";
    let sorry = "Sorry, we couldn’t find the page you’re looking for.";
    let go_back = "Go back";
